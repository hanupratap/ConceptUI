...
class PizzaFragment : BaseMvRxFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        pizza_recyclerview.adapter = foodAdapter
        ...
        withState(foodViewModel) { state ->
            ...
            when (state.pizzas) {
                is Loading -> {
                    ...
                    pizza_recyclerview.visibility = View.GONE
                }
                is Success -> {
                    progress_bar_pizza.visibility = View.GONE
                    pizza_recyclerview.visibility = View.VISIBLE
                    foodAdapter.setDishes(state.pizzas.invoke())
                }
                is Fail -> {
