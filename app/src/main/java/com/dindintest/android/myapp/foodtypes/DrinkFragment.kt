...
class DrinkFragment : BaseMvRxFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        foodAdapter = FoodAdapter(object : FoodAdapter.CartlistListener {
            override fun addToCart(dishId: Long) {
                ...
                foodViewModel.addDrinks(dishId)
            }
        ...
        drink_recyclerview.adapter = foodAdapter
    ...
    override fun invalidate() {
        withState(foodViewModel) { state ->
            ...
            when (state.drinks) {
                is Loading -> {
                    progress_bar_drink.visibility = View.VISIBLE
                    drink_recyclerview.visibility = View.GONE
                }
                is Success -> {
                    progress_bar_drink.visibility = View.GONE
                    drink_recyclerview.visibility = View.VISIBLE
                    foodAdapter.setDishes(state.drinks.invoke())
                }
                is Fail -> {
